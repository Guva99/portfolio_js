  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden h-full w-full">
      ...
      <motion.img 
         ...
         className="absolute top-[5%] left-[5%] w-24 h-24 blur-[3px]"
      />
      <motion.img 
         src={geoTriangle} alt=""
         ...
         className="absolute top-[8%] right-[8%] w-32 h-32 blur-[4px]"
      />
      <motion.img 
         src={geoCircle} alt=""
         ...
         className="absolute top-[15%] left-[15%] w-20 h-20 blur-[3px]"
      />
      ...
      <motion.img 
         ...
         className="absolute top-[25%] right-[20%] w-24 h-24 blur-[3px]"
      />
      <motion.img 
         src={geoPlus} alt=""
         ...
         className="absolute top-[32%] left-[25%] w-16 h-16 blur-[2px]"
      />
      ...
      <motion.img 
         ...
         className="absolute top-[45%] left-[2%] w-28 h-28 blur-[4px]"
      />
      <motion.img 
         src={geoCircle} alt=""
         ...
         className="absolute top-[50%] right-[5%] w-40 h-40 blur-[5px]"
      />
      <motion.img 
         src={geoTriangle} alt=""
         ...
         className="absolute top-[55%] left-[12%] w-24 h-24 blur-[4px]"
      />
      ...
      <motion.img 
         ...
         className="absolute top-[65%] right-[15%] w-16 h-16 blur-[2px]"
      />
      <motion.img 
         src={geoThunder} alt=""
         ...
         className="absolute top-[72%] left-[8%] w-32 h-32 blur-[4px]"
      />
      <motion.img 
         src={geoCircle} alt=""
         ...
         className="absolute top-[78%] right-[25%] w-20 h-20 blur-[2px]"
      />
      ...
      <motion.img 
         ...
         className="absolute top-[85%] left-[18%] w-24 h-24 blur-[3px]"
      />
      <motion.img 
         src={geoThunder} alt=""
         ...
         className="absolute top-[90%] right-[12%] w-28 h-28 blur-[3px]"
      />
      <motion.img 
         src={geoTriangle} alt=""
         initial={{ opacity: 0 }} animate={{ opacity: 0.06, rotate: 360, scale: [1, 1.1, 1] }}
         ...
         className="absolute top-[95%] right-[35%] w-20 h-20 blur-[2px]"
      />
      <motion.img 
         src={geoCircle} alt=""
         ...
         className="absolute top-[92%] left-[5%] w-32 h-32 blur-[4px]"
      />
    </div>
  );
}
