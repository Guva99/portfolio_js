                  ...
                  <AnimatePresence>
                    {hoveredIndex === index && (
                      <motion.div
                        ...
                        className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-64 p-2 rounded-xl bg-slate-900/50 backdrop-blur-xl border border-white/10 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)] overflow-hidden"
                      >
